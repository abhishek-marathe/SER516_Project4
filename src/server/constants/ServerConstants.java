...
public class ServerConstants {
	...
	public static final String TITLE = "Client (Lab 3, Team 6) Server";
	...
	public static final String STOP_SERVER_EXCEPTION_MESSAGE = "An Exception has occurred while stopping server";
